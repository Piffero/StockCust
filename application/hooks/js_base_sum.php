    ...
    <script>
        ...
        function showMethodSave(id)
	    {
	    	...
	    	if ( $("#iNome").length ){ 
     	    ...
     	    var url = "<?php echo site_url('param/base_sum/save')?>";
     	   
	    	$.post(url, {regras_nome:nome, regras_basecalculo:bc}, function(data,status){	    		   
        ...
        function showMethodDelete()
        {
	    	...
	    	for (i=0; i<=c.length-1; i++){
	    	 ...
	    	 var url = "<?php echo site_url('param/base_sum/delete')?>";
        ...
        {
        	 var url = "<?php echo site_url('param/base_sum/set_page_table')?>";
        ...
        {   
        	var url = "<?php echo site_url('param/base_sum/status')?>";
        	         
        	if (document.getElementById("active_"+id).getAttribute('class') == 'active'){
        	    $.post(url,{regra_id:id,regras_deletado:'1'},function(data,status){		            
        	   	...
        	   	$.post(url,{regra_id:id,regras_deletado:'0'},function(data,status){		            
